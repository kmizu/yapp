...
import static jp.gr.java_conf.mizu.yapp.util.SystemProperties.FILE_SEPARATOR;
...
import jp.gr.java_conf.mizu.yapp.Ist.Fail;
import jp.gr.java_conf.mizu.yapp.Ist.Function;
import jp.gr.java_conf.mizu.yapp.Ist.GenerateFailure;
...
import jp.gr.java_conf.mizu.yapp.Ist.Visitor;
...
public class CodeGeneratorFromIst 
  ...
  public Void visit(ParserUnit node, CodeContext context) {
    ...
    n("import java.util.*;");
    n("import java.io.*;");
    n("import jp.gr.java_conf.mizu.yapp.runtime.*;");
