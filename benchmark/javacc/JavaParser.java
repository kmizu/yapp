 ...
 * @author Júlio Vilmar Gesser (jgesser@gmail.com) - bug fixes and added AST generation
 */
  ...
  final public CompilationUnit CompilationUnit() throws ParseException {
    ...
    if (jj_2_1(2147483647)) {
      pakage = PackageDeclaration();
                                                                   line = pakage.getLine(); column = pakage.getColumn();
    } else {
      ;
    }
    label_1:
    while (true) {
      ...
      in = ImportDeclaration();
                               if(line==-1){line = in.getLine(); column = in.getColumn();} imports = add(imports, in);
    }
    label_2:
    while (true) {
      switch (jj_nt.kind) {
      ...
      tn = TypeDeclaration();
                             if(line==-1){line = tn.getLine(); column = tn.getColumn();} types = add(types, tn);
    }
    switch (jj_nt.kind) {
    case 0:
      jj_consume_token(0);
    ...
    {if (true) return new CompilationUnit(line == -1 ? 0 : line, column, pakage, imports, types);}
 ...
 */
  final public TypeDeclaration TypeDeclaration() throws ParseException {
   ...
   TypeDeclaration ret;
    ...
    case SEMICOLON:
      jj_consume_token(SEMICOLON);
        {if (true) return new EmptyTypeDeclaration(token.beginLine, token.beginColumn);}
      break;
    case ABSTRACT:
    case CLASS:
    case ENUM:
  ...
  final public FieldDeclaration FieldDeclaration(Modifier modifier) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
    {if (true) return new FieldDeclaration(type.getLine(), type.getColumn(), modifier.modifiers, modifier.annotations, type, variables);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public VariableDeclarator VariableDeclarator() throws ParseException {
    ...
    {if (true) return new  VariableDeclarator(id.getLine(), id.getColumn(), id, init);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public MethodDeclaration MethodDeclaration(Modifier modifier) throws ParseException {
    ...
    case LT:
      typeParameters = TypeParameters();
                                       line=((TypeParameter)typeParameters.get(0)).getLine(); column=((TypeParameter)typeParameters.get(0)).getColumn();
      break;
    default:
      jj_la1[36] = jj_gen;
      ;
    ...
    type = ResultType();
                        if(line==-1){line=type.getLine(); column=type.getColumn();}
    jj_consume_token(IDENTIFIER);
                 name = token.image;
  ...
  final public Parameter FormalParameter() throws ParseException {
    ...
    id = VariableDeclaratorId();
    {if (true) return new Parameter(type.getLine(), type.getColumn(), modifier.modifiers, modifier.annotations, type, isVarArg, id);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ConstructorDeclaration ConstructorDeclaration(Modifier modifier) throws ParseException {
    ...
    jj_consume_token(RBRACE);
        ...
        {if (true) return new ConstructorDeclaration(line, column, modifier.modifiers, modifier.annotations, typeParameters, name, parameters, throws_, new BlockStmt(bLine, bColumn, stmts));}
    throw new Error("Missing return statement in function");
  }
    ...
    if (jj_2_10(2147483647)) {
      ...
      case LT:
        typeArgs = TypeArguments();
                                        line=((Type)typeArgs.get(0)).getLine(); column=((Type)typeArgs.get(0)).getColumn();
        break;
      default:
        jj_la1[45] = jj_gen;
        ;
      ...
      case LT:
        ...
        case LT:
          typeArgs = TypeArguments();
                                        if (line == -1) {line=((Type)typeArgs.get(0)).getLine(); column=((Type)typeArgs.get(0)).getColumn();}
          break;
        default:
          jj_la1[46] = jj_gen;
          ;
  ...
  final public InitializerDeclaration Initializer() throws ParseException {
    ...
    block = Block();
                                                                                  if(line==-1){line=block.getLine(); column=block.getColumn();}
 ...
 */
  ...
  final public ReferenceType ReferenceType() throws ParseException {
    ...
    {if (true) return new ReferenceType(type.getLine(), type.getColumn(), type, arrayCount);}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  final public Expression Expression() throws ParseException {
    ...
    if (jj_2_18(2)) {
      ...
      value = Expression();
                                                     ret = new AssignExpr(ret.getLine(), ret.getColumn(), ret, value, op);
    } else {
      ;
    }
    {if (true) return ret;}
  ...
  final public Expression ConditionalExpression() throws ParseException {
    ...
    case HOOK:
      ...
      right = ConditionalExpression();
                                                                  ret = new ConditionalExpr(ret.getLine(), ret.getColumn(), ret, left, right);
      break;
    default:
      jj_la1[60] = jj_gen;
      ;
  ...
  final public Expression ConditionalOrExpression() throws ParseException {
    ...
    while (true) {
      ...
      right = ConditionalAndExpression();
                                                                               ret = new BinaryExpr(ret.getLine(), ret.getColumn(), ret, right, BinaryExpr.Operator.or);
    }
    {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Expression ConditionalAndExpression() throws ParseException {
    ...
    while (true) {
      ...
      right = InclusiveOrExpression();
                                                                         ret = new BinaryExpr(ret.getLine(), ret.getColumn(), ret, right, BinaryExpr.Operator.and);
    }
    {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Expression InclusiveOrExpression() throws ParseException {
    ...
    while (true) {
      ...
      right = ExclusiveOrExpression();
                                                                        ret = new BinaryExpr(ret.getLine(), ret.getColumn(), ret, right, BinaryExpr.Operator.binOr);
    }
    {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Expression ExclusiveOrExpression() throws ParseException {
    ...
    while (true) {
      ...
      right = AndExpression();
                                                        ret = new BinaryExpr(ret.getLine(), ret.getColumn(), ret, right, BinaryExpr.Operator.xor);
    }
    {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Expression AndExpression() throws ParseException {
    ...
    while (true) {
      ...
      right = EqualityExpression();
                                                                  ret = new BinaryExpr(ret.getLine(), ret.getColumn(), ret, right, BinaryExpr.Operator.binAnd);
    }
    {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Expression EqualityExpression() throws ParseException {
    ...
    while (true) {
      ...
      right = InstanceOfExpression();
                                       ret = new BinaryExpr(ret.getLine(), ret.getColumn(), ret, right, op);
    }
    {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Expression InstanceOfExpression() throws ParseException {
    ...
    case INSTANCEOF:
      ...
      type = Type();
                                                              ret = new InstanceOfExpr(ret.getLine(), ret.getColumn(), ret, type);
      break;
    default:
      jj_la1[68] = jj_gen;
      ;
  ...
  final public Expression PrimaryPrefix() throws ParseException {
    ...
    default:
      ...
      if (jj_2_27(2147483647)) {
        ...
        jj_consume_token(DOT);
        jj_consume_token(CLASS);
                                            ret = new ClassExpr(type.getLine(), type.getColumn(), type);
      } else {
        switch (jj_nt.kind) {
        case IDENTIFIER:
          jj_consume_token(IDENTIFIER);
 ...
 */
  ...
  final public BlockStmt Block() throws ParseException {
    ...
    stmts = Statements();
    jj_consume_token(RBRACE);
    {if (true) return new BlockStmt(line, column, stmts);}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  final public Statement BlockStatement() throws ParseException {
    ...
    if (jj_2_35(2147483647)) {
      ...
      typeDecl = ClassOrInterfaceDeclaration(modifier);
                                                             ret = new TypeDeclarationStmt(typeDecl.getLine(), typeDecl.getColumn(), typeDecl);
    } else if (jj_2_36(2147483647)) {
      expr = VariableDeclarationExpression();
                                                   ret = new ExpressionStmt(expr.getLine(), expr.getColumn(), expr);
      jj_consume_token(SEMICOLON);
    } else {
      switch (jj_nt.kind) {
      case ASSERT:
  ...
  final public VariableDeclarationExpr VariableDeclarationExpression() throws ParseException {
    ...
    {if (true) return new VariableDeclarationExpr(type.getLine(), type.getColumn(), modifier.modifiers, modifier.annotations, type, vars);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ExpressionStmt StatementExpression() throws ParseException {
    ...
    case LPAREN:
      ...
      case RUNSIGNEDSHIFTASSIGN:
        ...
        case RUNSIGNEDSHIFTASSIGN:
          op = AssignmentOperator();
          value = Expression();
                                                             expr = new AssignExpr(expr.getLine(), expr.getColumn(), expr, value, op);
          break;
        default:
          jj_la1[106] = jj_gen;
          jj_consume_token(-1);
    ...
    jj_consume_token(SEMICOLON);
    {if (true) return new ExpressionStmt(expr.getLine(), expr.getColumn(), expr);}
    throw new Error("Missing return statement in function");
  }
...
/* Annotation Types. */
  ...
  final public AnnotationMemberDeclaration AnnotationTypeMemberDeclaration(Modifier modifier) throws ParseException {
    ...
    jj_consume_token(SEMICOLON);
          {if (true) return new AnnotationMemberDeclaration(type.getLine(), type.getColumn(), modifier.modifiers, modifier.annotations, type, name, defaultVal);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x0,0x48101000,0x1,0x0,0x0,0x0,0x40001000,0x8100000,0x48101000,0x100000,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x4a195000,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x4a195000,0x8100000,0x2094000,0x4a195000,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x0,0x0,0x0,0x0,0x0,0x42095000,0x0,0x0,0x0,0x0,0x0,0x22094000,0x6359f000,0x0,0x2094000,0x2094000,0x0,0x2094000,0x10000000,0x10000000,0x2094000,0x2094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x22094000,0x0,0x0,0x22094000,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0x22094000,0x0,0x0,0x0,0x2094000,0x0,0x0,0x2349e000,0x0,0x2349e000,0x0,0x0,0x0,0x22094000,0x820000,0x820000,0x4000000,0x62095000,0x22094000,0x22094000,0x62095000,0x22094000,0x0,0x0,0x0,0x22094000,0x40000,0x80000000,0x80040000,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x4a195000,0xa194000,0xa194000,0x800000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x20,0x8899c500,0x0,0x0,0x80000,0x0,0x8899c400,0x100,0x8899c500,0x100,0x0,0x0,0x10,0x0,0x0,0x10,0x0,0x0,0xc89dc781,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc89dc781,0x100,0x40040281,0xc89dc781,0x0,0x0,0x0,0x51241a81,0x51241a81,0x0,0x0,0x0,0x4000000,0x0,0x0,0x889dc681,0x0,0x0,0x4000000,0x0,0x0,0x51241a81,0xfbffdf8b,0x80000,0x40281,0x40281,0x0,0x40281,0x200000,0x200000,0x40281,0x40040281,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x51241a81,0x0,0x0,0x51241a81,0x0,0x0,0x0,0x0,0x0,0x11201800,0x0,0x0,0x0,0x0,0x1000800,0x0,0x10001000,0x10000000,0x51241a81,0x0,0x0,0x0,0x40281,0x0,0x0,0x73e61a8b,0x0,0x73e61a8b,0x0,0x0,0x0,0x51241a81,0x0,0x0,0x0,0xd9bdde81,0x51241a81,0x51241a81,0xd9bdde81,0x51241a81,0x0,0x0,0x0,0x51241a81,0x0,0x0,0x0,0x0,0x0,0x0,0x51241a81,0x51241a81,0x0,0x889dc781,0x40381,0x40381,0x0,};
   }
