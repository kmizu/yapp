...
public class NestedReader extends Reader {
  ...
  /**
   * Event listener to provide notification that the most recently
   * inserted character stream has reached its end.
   *
  ...
  private void restore() throws IOException {
    ...
    reader   = (Reader)readerStack.removeFirst();
    listener = (EOFListener)listenerStack.removeFirst();
  }
